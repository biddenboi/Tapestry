import { getRank, getRankLabel, getRankGroupPresentation } from '../rank/Rank.js';
...
export function buildProfileIdentity(player = {}, { rank = null, snapshotAt = null } = {}) {
  ...
  return Object.freeze({
    ...
    theme: firstDefined(player.theme, player.playerTheme, activeCosmetics.theme, 'default'),
    elo,
    rankGroup,
    rankLabel: String(suppliedRankLabel || getRankLabel(elo)),
