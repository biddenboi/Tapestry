...
const ALL_OVERVIEW_BLOCKS = Object.freeze([
  'text', 'stats', 'achievements', 'activity', 'rankGraph', 'highlights', 'goalContribution',
]);
...
export const PROFILE_VISIBILITY_POLICY = Object.freeze({
  ...
  [VISIBILITY_TIER.friend]: Object.freeze({
    label: 'Friend',
    allowedTabs: Object.freeze([PROFILE_TAB.overview, PROFILE_TAB.timeline, PROFILE_TAB.matches, PROFILE_TAB.social]),
    daybookScope: 'full',
    matchScope: 'full',
    socialScope: 'full',
    settingsScope: 'none',
  ...
  [VISIBILITY_TIER.dynamic]: Object.freeze({
    ...
    allowedTabs: Object.freeze([PROFILE_TAB.overview, PROFILE_TAB.timeline, PROFILE_TAB.matches]),
    daybookScope: 'recent',
    matchScope: 'summary',
    socialScope: 'current-threads',
    settingsScope: 'none',
    overviewBlockTypes: Object.freeze(['text', 'stats', 'achievements', 'activity', 'highlights', 'goalContribution']),
  ...
  [VISIBILITY_TIER.outside]: Object.freeze({
    ...
    socialScope: 'none',
    settingsScope: 'none',
    overviewBlockTypes: Object.freeze(['text', 'achievements']),
    canViewRichLastActive: false,
  }),
});
