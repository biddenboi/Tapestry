...
export default NiceModal.create(() => {
  ...
  const benefits = [
    ...
    },
    {
      ...
      desc: 'Build as many goal trees as your life requires. Free accounts are limited to five.',
    },
    {
      icon: '↔',
      title: 'Advanced data handling',
      desc: 'Unlock data export and tools for safer backups and transfers.',
    },
  ];
