...
export function isTaskRecommenderV12EligibleTask(task = {}, playerUUID = null) {
  ...
  // Planning tasks are workspace-wide. `playerUUID` personalizes the model and
  // owns its decision ledger; it must not hide a shared task merely because an
  // older record carries the profile that originally created it.
  void playerUUID;
