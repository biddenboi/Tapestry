 ...
 *
 * Names: hub, tasks, feed, shop, inventory, journal, profile, search,
 *        settings, notes, inbox, timer, bell, check, play, arrowRight, add, close, trophy, events
 */
...
const PATHS = {
  ...
  pass: (
    <>
      <path d="M10 1.5 17 5.5v9L10 18.5 3 14.5v-9Z" />
      <path d="m10 5 4 2.2v4.6L10 14l-4-2.2V7.2Z" opacity="0.55" />
      <circle cx="10" cy="9.5" r="1.3" fill="currentColor" stroke="none" />
      <line x1="10" y1="1.5" x2="10" y2="5" />
      <line x1="17" y1="5.5" x2="14" y2="7.2" />
      <line x1="17" y1="14.5" x2="14" y2="11.8" />
      <line x1="10" y1="18.5" x2="10" y2="14" />
      <line x1="3" y1="14.5" x2="6" y2="11.8" />
      <line x1="3" y1="5.5" x2="6" y2="7.2" />
    </>
  ),
  inventory: (
    <>
  ...
  search: (
    <>
      ...
      <line x1="12.5" y1="12.5" x2="18" y2="18" strokeWidth="1.8" />
    </>
  ),
  inbox: (
    <>
  ...
  play: (
    <>
      <circle cx="10" cy="10" r="8" />
      <path d="M8 6.5 L14 10 L8 13.5 Z" fill="currentColor" opacity="0.72" stroke="none" />
  ...
  arrowRight: (
    <>
      ...
      <polyline points="10.5,6.5 14,10 10.5,13.5" strokeWidth="1.6" />
    </>
  ),
  add: (
    <>
