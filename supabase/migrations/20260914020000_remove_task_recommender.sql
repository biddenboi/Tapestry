-- Retire Task Recommender portable model sync. Existing clients clean their
-- local model records and queued writes in SQLite migration 058.

begin;

delete from public.mobile_reference_records
where record_type = 'ml-model';
